...
/** Create an HTMLImageElement from the heart SVG template filled with the given color. */
export function loadHeartImage(color: string): Promise<HTMLImageElement | null> {
