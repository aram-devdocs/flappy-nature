...
export interface HeartIconProps {
  ...
  size?: number;
  /** Fill color for the heart path. Defaults to the --fn-violet CSS variable. */
  color?: string;
}

/** Heart-in-circle SVG icon used across game screens. */
export function HeartIcon({ size = 48, color = 'var(--fn-violet, #6500D9)' }: HeartIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" role="img" aria-label="Heart icon">
      <path
